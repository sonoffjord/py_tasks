...
# ЗАДАЧА 2
# На вход программе подается два натуральных числа a и b (a < ba < b).
# Напишите программу, которая находит
# натуральное число из отрезка [a \ b][a;b]
...
# суммы и повторить этот процесс,
...
while n != 0:
    ...
    n //= 10
print(count_3_num, count_last_num, count_even,
      summ, multiply, count_zero_or_five, sep='\n')
